...
from alphaj_krx_crawler import get_stock_list_from_krx, save_stock_list_as_excel
import json, os
import pandas as pd
'''
...
print("{} - {}".format(crawled_time, "국내 증시 상장 종목 리스트"))
print(get_stock_list_from_krx())

# json_info = make_json(get_stock_list_from_krx())
# make_excel(json_info)